...
export const contingencyRules: Record<string, ContingencyRule> = {
  IBT_A: {
    ...
    affectedBuses: ["A"],
    requiredReliefMw: 72,
    explanation: "IBT A menanggung transfer ke bus A. Relief paling efektif adalah load bus A dengan prioritas rendah dan overshed kecil."
  },
  IBT_C: {
    ...
    explanation: "IBT C besar di sisi bus C. ADS mencari kombinasi load C terlebih dahulu sebelum mengambil load remote."
  },
  LINE_AB: {
    ...
    affectedBuses: ["A", "B"],
    requiredReliefMw: 88,
    explanation: "Line A-B mengikat area A dan B, sehingga load A/B diberi bobot relief lebih tinggi daripada load C."
  },
  LINE_BC: {
    ...
    affectedBuses: ["B", "C"],
    requiredReliefMw: 92,
    explanation: "Line B-C mengikat area B dan C. ADS menghindari shedding bus A jika kombinasi B/C masih cukup."
  },
  LINE_AC: {
    ...
    explanation: "Line A-C adalah tie utama antar area. Kombinasi A/C dinilai paling langsung untuk menurunkan transfer."
  },
  LINE_COUPLER: {
    ...
    affectedBuses: ["B"],
    requiredReliefMw: 52,
    explanation: "Coupler bus B membuat beban B menjadi target paling efektif karena relief langsung menurunkan arus antar busbar."
  },
  GEN_A1: {
    ...
    affectedBuses: ["A", "B"],
    requiredReliefMw: 95,
    explanation: "Jika KIT A1 turun, defisit paling terasa di area A/B. ADS memilih load prioritas rendah sebelum beban kritikal."
  },
  GEN_A2: {
    ...
    affectedBuses: ["A", "B"],
    requiredReliefMw: 74,
    explanation: "KIT A2 loss membutuhkan relief sedang di area A/B dengan overshed minimum."
  },
  GEN_C1: {
    ...
    affectedBuses: ["C", "B"],
    requiredReliefMw: 90,
    explanation: "KIT C1 loss lebih aman ditangani oleh kombinasi C/B agar transfer dari area lain tidak membesar."
  },
  GEN_C2: {
    ...
    affectedBuses: ["C", "B"],
    requiredReliefMw: 80,
    explanation: "KIT C2 derate/loss memerlukan shedding C/B yang cukup tanpa melepas beban terlalu banyak."
  }
};
...
export function decisionForOpenContingencies(objectStates: Record<string, string>, feeders: Feeder[]): AdsDecision | null {
  ...
  return ranked[0] ? { ...ranked[0], status: ranked[0].selected ? "executed" : "blocked", mode: "LIVE ADS EXECUTION" } : null;
}
